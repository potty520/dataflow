...
const routes = [
  { path: '/login', component: Login, meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'portal/config', component: () => import('../views/portal/config/index.vue'), meta: { title: '系统配置' } },
      { path: 'portal/security', component: () => import('../views/portal/security/index.vue'), meta: { title: '安全设置' } },
      { path: 'portal/profile', component: () => import('../views/portal/profile/index.vue'), meta: { title: '个人中心' } },
      ...
      { path: 'governance/proxynode', component: () => import('../views/governance/proxynode/index.vue'), meta: { title: '代理节点' } },
      { path: 'governance/monitor', component: () => import('../views/governance/monitor/index.vue'), meta: { title: '治理监控' } },
      { path: 'governance/collector', component: () => import('../views/governance/collector/index.vue'), meta: { title: '元数据采集' } },
      { path: 'governance/designer', component: () => import('../views/governance/designer/index.vue'), meta: { title: '模型设计器' } },
      { path: 'governance/domain', component: () => import('../views/governance/domain/index.vue'), meta: { title: '业务域' } },
      ...
      { path: 'development/resource', component: () => import('../views/development/resource/index.vue'), meta: { title: '资源库' } },
      { path: 'development/gantt', component: () => import('../views/development/gantt/index.vue'), meta: { title: '甘特图' } },
      { path: 'development/monitor', component: () => import('../views/development/monitor/index.vue'), meta: { title: '任务监控' } },
      ...
      { path: 'service/monitor', component: () => import('../views/service/monitor/index.vue'), meta: { title: '服务监控' } },
      { path: 'service/debug', component: () => import('../views/service/debug/index.vue'), meta: { title: 'API调试' } },
      { path: 'service/unit', component: () => import('../views/service/unit/index.vue'), meta: { title: '服务单元' } },
      { path: 'service/ratelimit', component: () => import('../views/service/ratelimit/index.vue'), meta: { title: '限流配置' } },
      ...
      { path: 'infrastructure/monitor', component: () => import('../views/infrastructure/monitor/index.vue'), meta: { title: '资源监控' } },
      { path: 'infrastructure/resource-group', component: () => import('../views/infrastructure/resource-group/index.vue'), meta: { title: '资源组' } }
    ]
  }
]
